"""Shim: this module moved to ``mmcomposer.benchmark`` (Stage B migration).

Kept so existing in-repo ``import benchmark`` keeps working while consumers are
...
import mmcomposer.benchmark as _moved  # noqa: E402
