"""Shim: this module moved to ``mmcomposer.combos`` (Stage B migration).

Kept so existing in-repo ``import combos`` keeps working while consumers are
...
import mmcomposer.combos as _moved  # noqa: E402
