"""Shim: this module moved to ``mmcomposer.compiler`` (Stage B migration).

Kept so existing in-repo ``import compiler`` keeps working while consumers are
...
import mmcomposer.compiler as _moved  # noqa: E402
