"""Shim: this module moved to ``mmcomposer.mmc`` (Stage B migration).

Kept so existing in-repo ``import mmc`` keeps working while consumers are
...
import mmcomposer.mmc as _moved  # noqa: E402
