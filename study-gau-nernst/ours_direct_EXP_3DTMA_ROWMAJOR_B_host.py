...
Config: BM=128 BN=256 BK=64 NS=4 GROUP_SIZE_M=8 NUM_WARPS=4 TMA_STORE=0 PERSISTENT=1 EPILOGUE_OVERLAP=1 EPILOGUE_SPLIT=0 EPILOGUE_DIRECT=1 TCGEN05_LD_WIDTH=16 EXP_6W=1 L1_NO_ALLOC=1 EXP_3DTMA_ROWMAJOR_B=1
...
mod, fns = compile_kernel(os.path.join(HERE, "ours_direct_EXP_3DTMA_ROWMAJOR_B_kernel.cu"),
...
def setup(M, N, K):
    ...
    B_tmap = encode_tensor_map(
        dtype=TMA_BFLOAT16, rank=3, gptr=B.data_ptr(),
        global_dim=[64, K, N // 64], global_strides=[N * ELEM_BYTES, 128],
        box_dim=[64, BK, BN_LOCAL // 64], element_strides=[1, 1, 1],
        swizzle=TMA_SWIZZLE_128B)
