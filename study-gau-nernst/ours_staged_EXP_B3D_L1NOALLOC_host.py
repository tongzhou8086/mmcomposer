...
Config: BM=128 BN=256 BK=64 NS=4 GROUP_SIZE_M=8 NUM_WARPS=4 TMA_STORE=0 PERSISTENT=1 EPILOGUE_OVERLAP=1 EPILOGUE_SPLIT=1 B_3D_TMA=1 L1_NO_ALLOC=1
...
mod, fns = compile_kernel(os.path.join(HERE, "ours_staged_EXP_B3D_L1NOALLOC_kernel.cu"),
