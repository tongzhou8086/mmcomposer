...
Config: BM=128 BN=256 BK=64 NS=4 GROUP_SIZE_M=8 NUM_WARPS=4 TMA_STORE=0 PERSISTENT=1 EPILOGUE_OVERLAP=1 EPILOGUE_SPLIT=0 EPILOGUE_DIRECT=1 TCGEN05_LD_WIDTH=16 EXP_6W=1 L1_NO_ALLOC=1
...
mod, fns = compile_kernel(os.path.join(HERE, "ours_direct_EXP_6W_L1NOALLOC_kernel.cu"),
